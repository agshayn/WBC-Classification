...
# 
# **Référence littérature** : Healthcare 2022 ; Habibzadeh 2013 — 138M params
# 
# **Notes** :
# - Modèle TRÈS lourd (138M params).
# - Batch size réduit à 16 pour tenir en VRAM.
# - LR faible (1e-4) car fine-tuning.
# - Backbone à LR/10, head à LR normal.
