...
# 
# **Référence littérature** : Sharma et al. 2022 — 98.84% accuracy rapportée
# 
# **Notes** :
# - Dense connections, 8M params — léger et précis.
# - Très efficace pour les datasets médicaux.
# - Réutilisation features entre couches.
