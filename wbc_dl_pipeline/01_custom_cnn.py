...
# 
# **Référence littérature** : Healthcare 2022, Fig.9(a) — Conv+BN+Dropout architecture
# 
# **Notes** :
# - Modèle léger entraîné from scratch (~5M params).
# - LR plus élevé (1e-3) car pas de pré-entraînement.
# - Plus d'époques nécessaires pour converger.
# - Batch size plus grand car peu gourmand en VRAM.
