...
candidates = [
    ...
    ("ConvNeXt V4",    "best_convnext_v4_final.pth"),
    ("Swin-T V4",      "best_swin_v4_final.pth"),
    ("V4 Stage1",      "best_v4_stage1.pth"),
    ("ResNet50 S1",    "best_resnet50_v4_stage1.pth"),
    ("ConvNeXt S1",    "best_convnext_v4_stage1.pth"),
    ("Swin-T S1",      "best_swin_v4_stage1.pth"),
]
...
def create_convnext_small(num_classes=13):
...
def create_swin_t(num_classes=13):
