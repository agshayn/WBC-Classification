...
# 
# **Référence littérature** : Habibzadeh et al. 2018 — 99.46% accuracy rapportée
# 
# **Notes** :
# - ATTENTION : Inception nécessite des images 299x299 (pas 224).
# - Le code l'adapte automatiquement (img_size=299).
# - Auxiliary classifier activé pendant l'entraînement.
